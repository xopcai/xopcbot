  ...
  return (
    <Dialog.Root open={open} onOpenChange={(o) => !o && onClose()}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="xopcbot-dialog-content fixed inset-0 z-[81] flex h-[100dvh] max-h-[100dvh] w-screen max-w-none flex-col overflow-hidden border-0 bg-surface-panel shadow-none outline-none">
