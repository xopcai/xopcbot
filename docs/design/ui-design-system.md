...
> **版本**: v1.1 · **建立时间**: 2026-03 · **修订**: 2026-03-26（Gateway Web 与 Apple 系统 UI 中性色、字体栈、阴影 token 对齐，见 §2.5、§13.1）
...
| **Focus** | 键盘聚焦 | `ring-2 ring-accent ring-offset-2`（或 `focus-visible:ring-accent`），永远不能去掉 |
...
hover:bg-surface-hover active:scale-95 transition-all duration-150
```

**幽灵按钮 (Ghost)** — 最低视觉权重，用于工具栏、列表操作
```
text-fg-muted rounded-xl px-3 py-1.5 text-sm font-medium
hover:bg-surface-hover hover:text-fg active:scale-95 transition-all duration-150
```
